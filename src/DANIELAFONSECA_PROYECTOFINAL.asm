...
; Version: 1.0
; Descripci�n: Este proyecto implementa un Vel�dromo
;
;===============================================================================
...
MaxCountTicks:    EQU 100    ; Cantidad m�xima de ticks para los d�gitos

DIG1:             EQU $01    ; D�gito 1 de la pantalla MUX
DIG2:             EQU $02    ; D�gito 2 de la pantalla MUX
DIG3:             EQU $04    ; D�gito 3 de la pantalla MUX
DIG4:             EQU $08    ; D�gito 4 de la pantalla MUX
...
TCorrer_Est2:
                BrClr Banderas_1,LongP2,FIN_TCorrer_2 ; Se activ� bot�n de inicio?
                Ldaa Vueltas                      ; Si se alcanz� NumVueltas,
                Cmpa NumVueltas                   ; limpiar Vueltas al empezar
                Bne Skip_Reset                    ; nuevo ciclo
                Clr Vueltas
Skip_Reset      BClr PortRele,Rele                ; Apagar rel�
...
TCorrer_Est4:
                BrClr Banderas_1,ShortP1,FIN_TCorrer_4 ; Se activ� S1 (PH3)?
...
TCorrer_Est5:
                BrClr Banderas_1,ShortP2,Bra_To_Fin ; Se activ� S2 (PH0)?
                ...
                Movw #Msg_TimerPant_P1,Msg_L1     ; Se envia Mensaje TimerPant
                Movw #Msg_TimerPant_P2,Msg_L2     ; a la pantalla LCD
                BClr Banderas_2,LCD_OK            ; Se borra la bandera LCD_OK
                Clra                              ; Obtener valor de Timer
                Ldab TimerIniPant                 ; IniPant en segundos
                Ldx #10
                Idiv                              ; TimerIniPant/10
                Tfr X,A
                Jsr BIN_BCD_MUXP
                ...
                Tfr X,A
                Jsr BIN_BCD_MUXP
                Movb BCD,BCD1                     ; Mostrar en Dsp3 y Dsp4
                Jsr BCD_7Seg
                Movw #TCorrer_Est6,EstPres_TCorrer
Bra_To_Fin      Bra FIN_TCorrer_5
Fuera_Rango     Movw #Msg_Alerta_Vel_P1,Msg_L1    ; Se envia Mensaje Alerta
                Movw #Msg_Alerta_Vel_P2,Msg_L2    ; a la pantalla LCD
                BClr Banderas_2,LCD_OK            ; Se borra la bandera LCD_OK
                Ldaa Velocidad                    ; La velocidad es mayor a
                Cmpa #99                          ; 99 km/h?
                Bhi Poner_Guion                   ; Si lo es, mostrar guiones
                Ldaa Velocidad                    ; Sino, mostrar Velocidad en
                Jsr BIN_BCD_MUXP                  ; Dsp1 y Dsp2
                Movb BCD,BCD2
                Movb #OFF,BCD1                    ; Mantener Dsp3 y Dsp4 OFF
                Bra Borrar_Timers
Poner_Guion     Movb #Guiones,BCD2                ; Cargar guiones
                Movb #Guiones,BCD1
Borrar_Timers   Jsr BCD_7Seg
                Clr TimerIniPant                  ; Borrar timers
                Clr TimerFinPant
                Movb #tTimerError,TimerError      ; Cargar timer error
...
;===============================================================================
;
; Descripcion: Esta subrutina realiza los c�lculos de DeltaT (tiempo que tarda
...
; ci�n de Inicio de Mensaje) y TimerFinPant (tiempo para alcanzar la posici�n
; de la pantalla)
;
; Ecuaciones:
